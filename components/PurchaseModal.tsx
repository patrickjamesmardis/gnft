...
export default function PurchaseModal({ itemId, price }: { itemId: BigNumber, price: BigNumber }) {
    const { purchaseModalOpen, setPurchaseModalOpen, isPurchasing, purchaseStatus, purchaseItem } = useContext(WalletContext);
