...
export default function ListItemModal({ tokenId }) {
    const { prettyAddress, marketAddress, sellStatus, listItem, marketApproval, getMarketApproval, approvalStatus, isApproving, isSelling, listItemModalOpen, setListItemModalOpen } = useContext(WalletContext);
