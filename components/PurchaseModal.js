    ...
    return <ComposedModal open={purchaseModalOpen} onClose={() => { setPurchaseModalOpen(false) }}>
        ...
        <ModalBody>
            <p style={{ marginBottom: '1rem' }}>
                Upon purchase, the artist will receive a 20% royalty, and the market will receive a 10% listing fee. The remainder of the funds will go to the seller, and the GNFT will be transferred to you.
            </p>
        </ModalBody>
        <ModalFooter>
